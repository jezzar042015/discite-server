<template>
    <svg width="250px" height="250px" viewBox="0 0 61.7998 61.7998" xmlns="http://www.w3.org/2000/svg" fill="#000000">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <g data-name="Layer 2" id="Layer_2">
                <g data-name="—ÎÓÈ 1" id="_ÎÓÈ_1">
                    <circle cx="30.8999" cy="30.8999" fill="#a7c8ec" r="30.8999"></circle>
                    <path
