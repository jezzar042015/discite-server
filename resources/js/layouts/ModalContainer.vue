<template>
    <teleport to='#app'>
        <div v-if="isVisible"
            class="bg-black/80 fixed h-lvh w-screen grid place-items-center px-2 z-20 mt-0 dark:bg-black/75 dark:shadow-sm">
            <div
                class="flex flex-col bg-white shadow h-screen w-full md:h-5/6 md:w-3/4 md:rounded-lg p-4 md:p-6 dark:bg-gray-800 md:-mt-20">
                <slot name="head"></slot>

                <div class="overflow-y-auto flex-1 flex flex-col py-4 gap-10">
                    <slot name="main">
